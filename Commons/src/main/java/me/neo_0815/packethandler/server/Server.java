...
import me.neo_0815.packethandler.*;
...
public abstract class Server {
	 ...
	 * @see #Server(InetAddress, int, Properties)
	 */
	 ...
	 *
	 * @throws IOException if an I/O error occurs when opening the {@link ServerSocket}
	 * @see ShutdownHooks#registerServer(Server)
	 */
	...
	/**
	 * Starts the {@link AcceptingThread} of this instance.
	 */
	public void start() {
		...
		ShutdownHooks.registerServer(this);
	}
	...
	/**
	 * Interrupts the {@link AcceptingThread} of this instance and disconnects all {@linkplain ClientConnection connections}.
	 *
	 * @see #disconnectAll()
	 */
	public void stop() {
	 ...
	 *
	 * @see ClientConnection#stop()
	 */
	@Synchronized("clients")
	public void disconnectAll() {
		clients.values().forEach(ClientConnection::stop);
		clients.clear();
	}
	...
	/**
	 * Disconnects the {@linkplain ClientConnection client} associated with the {@link UUID} {@code client} from the server.
	 *
	...
	public void disconnectClient(final UUID client) {
		computeOnClientIfPresent(client, ClientConnection::stop);
