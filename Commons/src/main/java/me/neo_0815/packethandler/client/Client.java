...
import me.neo_0815.packethandler.ShutdownHooks;
...
public abstract class Client extends Connection {
	 ...
	 * @see #Client(String, int, Properties)
	 */
	 ...
	 * @throws UnknownHostException if the IP address of the host could not be determined
	 * @throws IOException          if an I/O error occurs when creating the {@link Socket}
	 * @see #Client(UUID, String, int, Properties)
	 */
	 ...
	 * @throws UnknownHostException if the IP address of the host could not be determined
	 * @throws IOException          if an I/O error occurs when creating the {@link Socket}
	 * @see #Client(UUID, InetAddress, int, Properties)
	 */
	 ...
	 * @throws UnknownHostException if the IP address of the host could not be determined
	 * @throws IOException          if an I/O error occurs when creating the {@link Socket}
	 * @see ShutdownHooks#registerClient(Client)
	 */
	...
	public void start() throws IOException {
		...
		ShutdownHooks.registerClient(this);
	}
