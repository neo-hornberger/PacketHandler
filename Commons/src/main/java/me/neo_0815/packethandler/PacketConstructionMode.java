...
public final class PacketConstructionMode {
	/**
	 * The default mode for packet construction.
	 * <p>
	 * First the id of the packet will be written as a long.
	 * Then the length of the following data will be written as an integer.
	 * At the end the data will be written.
	 * </p>
	 */
