...
public class Properties {
	...
	@NonNull ExceptionHandlingType exceptionHandlingType = ExceptionHandlingType.STOP;
	...
	public Properties copy() {
		...
		copy.exceptionHandlingType = exceptionHandlingType;
	...
	public enum ExceptionHandlingType {
		...
		public void handle(final Connection connection, final Exception e) {
			switch(this) {
				case PRINT:
					e.printStackTrace();
					break;
