...
public final class PhasedPacketRegistry<P extends IPhase<P>> extends AbstractPacketRegistry {
	private final HashMap<P, HashMap<Long, Supplier<? extends PacketBase<?>>>> incoming = new HashMap<>(), outgoing = new HashMap<>();
	private final HashMap<P, HashMap<IPacketFactory, Long>> factoryCacheIncoming = new HashMap<>(), factoryCacheOutgoing = new HashMap<>();
	
	private final P startPhase;
