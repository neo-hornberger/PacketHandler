...
public final class PacketRegistry extends AbstractPacketRegistry {
	private final HashMap<Long, Supplier<? extends PacketBase<?>>> incoming = new HashMap<>(), outgoing = new HashMap<>();
	private final HashMap<IPacketFactory, Long> factoryCacheIncoming = new HashMap<>(), factoryCacheOutgoing = new HashMap<>();
