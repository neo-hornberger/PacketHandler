...
import me.neo_0815.packethandler.bridge.BridgedPacket;
...
public class TestPacketHandler {
	...
	public static void main(final String[] args) throws IOException {
		...
		final Bridge bridge = new Bridge(8080, prop, new HostPortPair(8081), prop) {
			...
			@Override
			protected BridgedPacket onPacketReceived(final Side sender, final UUID client, final PacketBase<?> packet, final long id) {
